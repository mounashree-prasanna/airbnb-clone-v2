...
export const checkSession = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const storedRole = getStoredRole() || "traveler";
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(checkSession.fulfilled, (state, action) => {
        ...
        // ✅ Stay authenticated if token & role exist and backend didn't deny session
      ...
      .addCase(checkSession.rejected, (state, action) => {
        ...
        // ❗ Preserve local credentials on transient network errors
